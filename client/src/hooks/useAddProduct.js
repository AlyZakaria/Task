...
function check(props) {
  ...
  if (props.type === "Book") {
    if (
      props.weightRef.current.value === "" ||
      !attributesValid(props.weightRef.current.value)
    ) {
    ...
    if (
      ...
      !attributesValid(props.sizeRef.current.value)
    ) {
    ...
    if (
      ...
      width === "" ||
      height === "" ||
      !attributesValid(length, width, height)
    ) {
